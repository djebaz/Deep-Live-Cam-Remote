...
# NOTEBOOK_META_B64=
...
"""CELL: Clone and install (resumable - safe to re-run after session restart)"""
...
# %% [markdown] cell=3 id=config-heading
"""MARKDOWN
## 3. Configure Colab paths and processing options
"""ENDMARKDOWN

# %% [code] cell=4 id=config meta_b64=eyJjZWxsVmlldyI6ImZvcm0ifQ==
...
# %% [markdown] cell=5 id=api-heading
"""MARKDOWN
...
# %% [markdown] cell=6 id=tailscale-setup-heading
"""MARKDOWN
...
# %% [code] cell=7 id=tailscale-install
"""CELL: Install Tailscale (resumable - safe to re-run)"""
...
# %% [code] cell=8 id=tailscale-auth
"""CELL: Start Tailscale and authenticate (resumable)"""
...
# %% [code] cell=9 id=tailscale-ip
"""CELL: Get Tailscale IP address (optional - shown above if connected)"""
