...
- Replace raw Live capture width/height controls with Capture mode plus Send scale: custom capture dimensions are requested from OBS/OpenCV at Live startup, while Send scale remains hot-change before WebSocket encoding.
