...
- Replace raw Live capture width/height controls with a hot-change Capture scale selector, including custom exact send width/height, that resizes the actual decoded webcam frame before WebSocket encoding.
